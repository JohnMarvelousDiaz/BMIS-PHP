...
<div id="navbar" class="navbar-font">
    ...
    <form action="" method="post" class="formContainer" autocomplete="off">  
      <a href="Announcement.php"><input type="hidden" name="id" value="<?php echo $row['id']?>"> 
      <i class="fa-sharp fa-solid fa-xmark" area-hidden="true" id="close-icon" onclick="closeForm()"></i></a>
  ...
  <div class="form-outline " id="a-content">
    ...
    <textarea class="form-control" name="content" rows="4"  required=""><?php echo $row['content']?></textarea>
  </div>

  
  <input type="submit" name="submit" value="Edit Announcement" class="btn btn-success save-btn form-control" >
</form>
</div>
 </div>
        <?php
          if(isset($_POST['submit']) ) {
            ...
            $query = "UPDATE `tblannouncements` SET `title`='$title',`date`='$date',`content`='$content' WHERE id='$id'";
            $sql = mysqli_query($conn,$query);
  ...
  <?php
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <tr class="text-center" >
                    ...
                    <td><div class="text-justify" style="word-wrap: break-word; white-space: normal !important; "><?php echo $row['content'] ?></div></td>
