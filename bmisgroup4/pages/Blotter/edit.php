...
<head>
    ...
    <link rel="stylesheet" href="../../css/Blotter_edit.css">
...
<div id="navbar" class="navbar-font">
    ...
    <?php
      ...
      $id = $_POST['id'];
      $query = "SELECT * FROM `tblblotters` WHERE `id`='$id'";
        ...
        $row = mysqli_fetch_array($sql)
          ?>
            ...
            <div class="formPopup" id="popupForm">
              ...
              <a href= "Blotter.php"><i class="fa-sharp fa-solid fa-xmark" area-hidden="true" id="close-icon" ></i></a>
                
                <div class="form-group col-sm-6">  
                    <strong>Complainant:</strong>  
                    <input type="text" name="complainant" class="form-control" readonly value="<?php echo $row['complainant']?>">  
                  </div>  
                    
                  <div class="form-group col-sm-6">  
                    <strong>Person to Complain:</strong>  
                    <input type="text" name="ptc" class="form-control" readonly  value="<?php echo $row['ptc']?>">  
                  </div>  

                  <div class="form-group col-sm-6">  
                    <strong>Complaint:</strong>  
                    <input type="text" name="complaint" class="form-control" readonly  value="<?php echo $row['complaint']?>">  
                  </div>  

                  <div class="form-group col-sm-6">  
                    <strong>Location of Incidence:</strong>  
                    <input type="text" name="loi" class="form-control" readonly value="<?php echo $row['loi']?>">  
                  </div>  
                  ...
                  <button type="submit" name="submit" id="fileblotter" class="btn btn-success save-btn form-control" onclick="closeForm()">Update Blotter</button>
          </form>
        </div>
        <?php
          if(isset($_POST['submit']) ) {
            ...
            $query = "UPDATE `tblblotters` SET `complainant`='$complainant',`ptc`='$ptc',`complaint`='$complaint',`loi`='$loi',`date`='$date',`status`='$status' WHERE id='$id'";
            $sql = mysqli_query($conn,$query);
    ...
    ?>
    <h3 style="color: #2C8F82; text-align: left ;">Blotter</h3>
