...
<head>
    ...
    <link rel="stylesheet" href="../../css/Permituser.css">
...
<?php
  ...
  <a href="../Permituser/Permituser.php">
    ...
    <button class="certs"><i class="fa-regular fa-newspaper"></i>Certification<i class="fa-solid fa-circle-chevron-down" style="margin-left: 32px;"></i></button>
        <div id="certs">
        <a href="../Permituser/Permituser.php" class="certs active"><i class="fa-solid fa-clipboard-check"></i>Permit</a>
    ...
    <?php  }}?>
    <div class="main">
        <button type="submit" id="btn-submit" onclick="openForm()">Request Permit</button>  
            ...
            <div class="formPopup" id="popupForm">
              <form action="add.php" method="post" class="formContainer" autocomplete="off">
                ...
                <div class="form-group col-sm-6">  
                    ...
                    <input type="text" name="bowner" class="form-control" readonly  value="<?php echo $_SESSION['name'];?>">  
                  </div>  
                  ...
                  <div class="form-group col-sm-6">  
                      ...
                      <input type="text" name="baddress" class="form-control"  required="">  
                  </div>  
      
                  <div class="form-group col-sm-6">  
                    <strong>Type of Business:</strong>  
                    <input type="text" name="bbusiness" class="form-control"  required="">  
                </div>   

                

                <input type="submit" name="submit" id="btn-permit" value="Request Permit" class="btn btn-success save-btn" >
          </form>
        </div>
        <br/>  
        ...
        <table id="example" class="table table-bordered table-hover " style="width:100%"> 
          <thead>  
            <th width="120px">Business Owner</th>  
            <th width="100px">Business Name</th> 
            <th width="180px">Business Address</th> 
            <th width="100px">Type of Business</th> 
            <th width="70px">OR Number</th>
            <th width="80px">Status</th>
          </thead>  
          <tbody>  
          <?php
    
    $sql = "SELECT * FROM `tblpermits` WHERE `user_id`='$userid'";
