...
<head>
    ...
    <link rel="stylesheet" href="../../css/Residentrecord_edit.css"> 
...
<div id="navbar" class="navbar-font">
    ...
    <?php
      ...
      $query = "SELECT * FROM `tblresidents` WHERE id='$id'";
      ...
      if($sql) {
       $row = mysqli_fetch_array($sql)
          ?>
            ...
            <div class="formPopup" id="popupForm">
              ...
              <input type="hidden" name="id" value="<?php echo $row['id']?>"> 
                <a href="Residentrecord.php"><i class="fa-sharp fa-solid fa-xmark" area-hidden="true" id="close-icon"></i></a>
                  <div class="form-group ">  
                    ...
                    <div class="form-group col-sm-6  ">  
                        <strong >Age:</strong>  
                        <input type="number" min="1" max="100"  name="age" class="form-control"  value="<?php echo $row['age']?>"> 
                    </div>  
                  ...
                  <div class="form-group ">  
                    ...
                    <input  type="submit" name="submit" value="Update Resident" class="btn btn-success save-btn form-control"  >
          ...
          if(isset($_POST['submit']) ) {
            ...
            $unameExist = mysqli_query($conn, "SELECT * FROM tblresidents WHERE `User` = '$uname' AND `id` !='$id' ");
            ...
            $query = "UPDATE `tblresidents` SET `name`='$name',`contact`='$contact',`age`='$age',`gender`='$gender',`address`='$address',`User`='$uname',`Pass`='$password' WHERE id='$id'";
            $sql = mysqli_query($conn,$query);
