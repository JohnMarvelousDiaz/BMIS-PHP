...
<head>
    ...
    <link rel="stylesheet" href="../../css/Clearanceuser.css">
...
<div class="dropdown" >
  ...
  <a href="../Permituser/Permituser.php">
    ...
    <img src="../../image/<?=$images['img_url']?>" alt="default profile" id="sidebar-pic" >
        ...
        <a href="../Clearanceuser/Clearanceuser.php" class="certs active"><i class="fa-solid fa-person-circle-check"></i>Clearance</a>
    ...
    <?php  }}?>
    <div class="main">
        <button type="submit" id="btn-submit" onclick="openForm()">Request Clearance</button>  
            ...
            <div class="formPopup" id="popupForm">
              <form action="add.php" method="post" class="formContainer" autocomplete="off">
                ...
                <div class="form-group col-sm-6">  
                  ...
                  <div class="form-group col-sm-6">  
                    <strong>Age:</strong>  
                    <input type="number" min="16"name="age" class="form-control"  required="">  
                  </div>  
                  ...
                  <div class="form-group col-sm-6">  
                   ...
                   <input type="submit" name="submit" id="btn-clearance" value="Request Clearance" class="btn btn-success save-btn " >
          </form>
        </div>
        <br/>  
    ...
    $sql = "SELECT * FROM tblclearances WHERE `user_id`='$userid'";
