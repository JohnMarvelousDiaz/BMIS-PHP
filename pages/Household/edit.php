...
<head>
    ...
    <link rel="stylesheet" href="../../css/Household_edit.css">
...
<div id="navbar" class="navbar-font">
    ...
    <?php
      ...
      $query = "SELECT * FROM `tblhouseholds` WHERE id='$id'";
      ...
      if($sql) {
        $row = mysqli_fetch_array($sql)
          ?>
            ...
            <div class="formPopup" id="popupForm">
              <form action="edit.php" method="post" class="formContainer" autocomplete="off">
              <input type="hidden" name="id" value="<?php echo $row['id']?>"> 
                <a href= "Household.php"><i class="fa-sharp fa-solid fa-xmark" area-hidden="true" id="close-icon" ></i></a>
                  <div class="form-group ">  
                      <label>Household #:</label>  
                      <input type="number" min="1" max="10000" name="household" class="form-control"  value="<?php echo $row['household']?>">  
                    </div>  
                    ...
                    <div class="form-group " >  
                        ...
                        <select name="zone" class="form-control" style="width: 200px;">
                          ...
                          <option value="Purok 7" <?php echo ($row['zone']=='Purok 7')?"selected":"";?>>Purok 7</option>
                        </select>
                    </div>  
        
                    <div class="form-group  ">
                        <label>Total Members:</label> 
                        <input type="number" min="1" max="100" name="totalm" class="form-control"  value="<?php echo $row['totalm']?>">  
                    ...
                    <input type="submit" name="submit" value="Update Household" class="btn btn-success save-btn form-control" >
              </form>
            </div>
        ...
        <?php
          if(isset($_POST['submit']) ) {
            ...
            $householdExist = mysqli_query($conn, "SELECT * FROM tblhouseholds WHERE `household` = '$household' AND `id` !='$id'");
        ...
        window.location.href='Household.php?error=Household No. already existed!';
            ...
            $query = "UPDATE `tblhouseholds` SET `household`='$household',`contact`='$contact',`zone`='$zone',`totalm`='$totalm',`head`='$head' WHERE id='$id'";
            $sql = mysqli_query($conn,$query);
