...
<head>
    ...
    <link rel="stylesheet" href="../../css/Indigency_edit.css">
...
<div id="navbar" class="navbar-font">
    ...
    <img src="../../images/admin.png" alt="default profile" id="sidebar-pic" >
        ...
        <a href="../Indigency/Indigency.php" class="certs active"><i class="fa-solid fa-id-card"></i>Indigency</a>
        </div>
    ...
    <?php
      include "config.php";
      $id = $_POST['id'];
      $query = "SELECT * FROM tblindigency WHERE `id`='$id'";
        ...
        $row = mysqli_fetch_array($sql)
          ...
          <div class="formPopup" id="popupForm">
            ...
            <input type="hidden" name="id" value="<?php echo $row['id']?>"> 
              ...
              <a href="Indigency.php"><i class="fa-sharp fa-solid fa-xmark" area-hidden="true" id="close-icon"></i></a>
              ...
              <div class="form-group col-sm-6">  
                ...
                <div class="form-group col-sm-6 " >  
                 ...
                 <input type="submit" name="submit" id="btn-clearance" value="Update Indigency" class="btn btn-success save-btn form-control" >
        </form>
      </div>
      <?php
      if(isset($_POST['submit']) ) {
            ...
            $ornumberExist = mysqli_query($conn, "SELECT * FROM tblindigency WHERE `ornumber` = '$ornumber' AND `id` !='$id'");
            if(mysqli_num_rows($ornumberExist)>0)
            {
              echo "<script>
              window.location.href='Indigency.php?error=OR number already given!';
              </script>";
            }
            else{
            $query = "UPDATE `tblindigency` SET `rname`='$rname',`age`='$age',`address`='$address',`ornumber`='$ornumber',`status`='$status',`date`=NOW() WHERE id='$id'";
            $sql = mysqli_query($conn,$query);  
            echo "<script> window.location.href='../Indigency/Indigency.php' </script>";
            }
          }       
      }   
    ?>
    <h3 style="color: #2C8F82; text-align: left;">Indigency</h3>
